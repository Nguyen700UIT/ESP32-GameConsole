...
const int melodyTheme[] PROGMEM = {
 // Measure 5
  NOTE_C4, -8, NOTE_C4, -8, NOTE_AS3, -4, NOTE_GS3, 8, NOTE_AS3, 8,
  
  // Measure 6
  NOTE_C4, 8, NOTE_DS4, 8, NOTE_F4, 8, NOTE_C5, 4, NOTE_AS4, 8, NOTE_GS4, 8, NOTE_FS4, 8,
  
  // Measure 7
  NOTE_C4, -8, NOTE_C4, -8, NOTE_AS3, -4, NOTE_GS3, 8, NOTE_AS3, 8,
  
  // Measure 8
  NOTE_B3, 8, NOTE_CS4, 8, NOTE_DS4, 8, NOTE_A4, 4, NOTE_GS4, 8, NOTE_FS4, 8, NOTE_F4, 8,
  
  // Measure 9 & 10 (Có nốt AS3 ngân dài nối từ nhịp 9 sang 10 được gộp thành nốt trắng)
  NOTE_G4, -8, NOTE_G4, -8, NOTE_F4, 4, NOTE_DS4, 8, NOTE_B3, 8,
  NOTE_AS3, 2, NOTE_CS4, 8, NOTE_AS3, 8, NOTE_AS3, 8, NOTE_GS3, 8, NOTE_F3, 8,
  
  // Measure 11 & 12 (Tương tự, AS2 ngân dài nối từ 11 sang 12)
  NOTE_GS3, -8, NOTE_GS3, -8, NOTE_G3, 4, NOTE_DS3, 8, NOTE_C3, 8, 
  NOTE_AS2, 2, NOTE_CS3, 8, NOTE_FS3, 8, NOTE_FS3, 8, NOTE_F3, 8, NOTE_DS3, 8,
  
  // Measure 13
  NOTE_C4, -8, NOTE_C4, -8, NOTE_AS3, -4, NOTE_GS3, 8, NOTE_AS3, 8,
  
  // Measure 14
  NOTE_C4, 8, NOTE_DS4, 8, NOTE_F4, 8, NOTE_AS3, -4, NOTE_F4, 4,
  
  // Measure 15
  NOTE_AS3, 4, NOTE_F4, 8, NOTE_AS3, 4, NOTE_GS3, -4,
  
  // Measure 16
  NOTE_FS3, 8, NOTE_GS3, 8, NOTE_AS3, 8, NOTE_FS3, 8, NOTE_DS3, -4, NOTE_DS3, 8
};
