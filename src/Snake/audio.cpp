...
const int melodyTheme[] PROGMEM = {
  // Measure 5
  NOTE_C4, -2, NOTE_CS4, 4,
  
  // Measure 6
  NOTE_DS4, 2, NOTE_F4, -4, NOTE_DS4, 16, NOTE_CS4, 16,
  
  // Measure 7 - 8
  NOTE_C4, 1, NOTE_C4, 1, 
  
  // Measure 9
  NOTE_F4, 4, NOTE_GS4, -4, NOTE_DS4, 4, NOTE_F4, 16, NOTE_DS4, 16,
  
  // Measure 10 (Ghi chú: nốt C#4 ngân dài 3.5 nhịp, quy đổi thành dotted half + eighth)
  NOTE_CS4, -2, NOTE_CS4, 8, NOTE_DS4, 16, REST, 16,
  
  // Measure 11
  NOTE_F4, 4, NOTE_GS4, 8, NOTE_DS4, 4, NOTE_AS4, 8, NOTE_C5, 8, NOTE_FS4, 8,
  
  // Measure 12
  NOTE_FS4, 1,
  
  // Measure 13
  NOTE_C4, 16, NOTE_C4, 16, NOTE_C4, 16, NOTE_C4, 16, NOTE_CS4, 16, REST, 16, NOTE_CS4, 16, REST, 16,
  NOTE_DS4, 16, REST, 16, NOTE_DS4, 16, REST, 16, NOTE_F4, 4,
  
  // Measure 14
  NOTE_F4, -4, NOTE_DS4, 16, NOTE_CS4, 16, NOTE_C4, 16, REST, 4, REST, 8, REST, 16,
  
  // Measure 15
  NOTE_C4, 16, NOTE_C4, 16, NOTE_C4, 16, NOTE_C4, 16, NOTE_CS4, 16, REST, 16, NOTE_CS4, 16, REST, 16,
  NOTE_DS4, 16, REST, 16, NOTE_DS4, 16, REST, 16, NOTE_C4, 4,
  
  // Measure 16
  NOTE_AS3, 8, NOTE_C4, 8, NOTE_AS3, 4, NOTE_GS3, 2
};
